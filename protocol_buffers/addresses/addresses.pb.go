...
const file_addresses_addresses_proto_rawDesc = "" +
	"\n" +
	"\x19addresses/addresses.proto\x12\taddresses\x1a\x1fgoogle/protobuf/timestamp.proto\"\x89\x02\n" +
	"\x06Person\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\x05R\x02id\x12\x14\n" +
	"\x05email\x18\x03 \x01(\tR\x05email\x125\n" +
	"\x06phones\x18\x04 \x03(\v2\x1d.addresses.Person.PhoneNumberR\x06phones\x12=\n" +
	"\flast_updated\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\vlastUpdated\x1aO\n" +
	"\vPhoneNumber\x12\x16\n" +
	"\x06number\x18\x01 \x01(\tR\x06number\x12(\n" +
	"\x04type\x18\x02 \x01(\x0e2\x14.addresses.PhoneTypeR\x04type\"8\n" +
	"\vAddressBook\x12)\n" +
	"\x06people\x18\x01 \x03(\v2\x11.addresses.PersonR\x06people*h\n" +
	"\tPhoneType\x12\x1a\n" +
	"\x16PHONE_TYPE_UNSPECIFIED\x10\x00\x12\x15\n" +
	"\x11PHONE_TYPE_MOBILE\x10\x01\x12\x13\n" +
	"\x0fPHONE_TYPE_HOME\x10\x02\x12\x13\n" +
	"\x0fPHONE_TYPE_WORK\x10\x03B\x14Z\x12internal/addressesb\x06proto3"

var (
	file_addresses_addresses_proto_rawDescOnce sync.Once
	file_addresses_addresses_proto_rawDescData []byte
)

func file_addresses_addresses_proto_rawDescGZIP() []byte {
	file_addresses_addresses_proto_rawDescOnce.Do(func() {
		file_addresses_addresses_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_addresses_addresses_proto_rawDesc), len(file_addresses_addresses_proto_rawDesc)))
	})
...
func file_addresses_addresses_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_addresses_addresses_proto_rawDesc), len(file_addresses_addresses_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
