...
func TestTitle(t *testing.T) {
	tests := []struct {
		...
		{"leading lowercase preserved", "the iPhone story", "The iPhone Story"},
		{"leading lowercase as first word", "iPhone sales soar", "iPhone Sales Soar"},
		{"leading lowercase as last word", "the rise of eBay", "The Rise of eBay"},
